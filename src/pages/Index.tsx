  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-6">
        <div className="flex items-center gap-2 border-2 border-background rounded-full px-4 py-2">
      ...
      <div className="scroll-container pt-20">
        {/* Hero Section Box */}
        <section className="content-box min-h-[90vh] flex items-center justify-center overflow-hidden relative">
          ...
          <div className="relative z-10 text-center max-w-5xl mx-auto px-6 py-20">
            ...
            <h1 className="text-7xl md:text-8xl lg:text-9xl font-black mb-8 italic tracking-tight leading-none">
              {t('home.title')}
            </h1>
        ...
        <section className="content-box min-h-screen py-20 px-6 md:px-12">
        ...
        <section className="content-box min-h-screen py-20 px-6 md:px-12 mb-6">
